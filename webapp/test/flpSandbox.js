		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ui5",
									"targetURL": "#nsui5testcoverage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsui5testcoverage-display": {
								"semanticObject": "nsui5testcoverage",
								"action": "display",
								"description": "test",
								"title": "ui5",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.ui5testcoverage",
									"url": sap.ui.require.toUrl("ns/ui5testcoverage")
								}
							}
						}
					}
